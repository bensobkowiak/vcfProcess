...
vcfProcess = function(inputfile,outputfile,caller="SAMtools",no.Cores=1,samples2remove=NULL,samples2include=NULL,indelProcess=FALSE,DP_low=5,lowqual=20,hetProp=0.9,misPercent=80,repeatfile=NULL,disINDEL=NULL,excludeMix=FALSE){
  ...
  if (!is.null(samples2include)){
    ...
    vcf<-vcf[,(which(is.element(names,include))+9)]
